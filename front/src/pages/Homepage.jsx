...
import { 
  ...
  fetchSolvedProblems, 
  selectAllProblems, 
  selectSolvedProblems, 
  selectProblemsLoading,
  selectIsProblemSolved,
  clearProblems
...
export default function Homepage() {
  ...
  const solvedProblems = useSelector(selectSolvedProblems);
  ...
  // Fetch problems from Redux on mount
  useEffect(() => {
    // Only fetch if we don't have problems or they're stale (older than 5 minutes)
    const shouldFetch = problems.length === 0;
