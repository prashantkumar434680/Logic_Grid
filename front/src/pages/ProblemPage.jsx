...
//         // Fetch video data for editorial
//         try {
//           const videoResponse = await axiosClient.get(`/video/problem/${problemId}`);
//           setVideoData(videoResponse.data);
//         } catch (videoError) {
//           // Video not found is okay, just don't show it
...
//                       <div className="text-gray-400 text-lg mb-2">No video editorial available yet</div>
//                       <p className="text-gray-500 text-sm">Check back later for video solutions and explanations</p>
//                     </div>
//                   )}
//                 </div>
//               )}
