      ...
      <div className="flex items-center gap-4 mb-6">
        ...
        <button
          ...
          className={`group flex items-center gap-3 px-5 py-3 rounded-xl transition-all duration-300 transform hover:scale-105 active:scale-95 ${isLiked
            ...
            : 'bg-slate-700/50 text-slate-300 border border-slate-600 hover:bg-slate-700 hover:text-green-400 hover:border-green-500/30'
            }`}
        >
          <div className="relative">
            ...
            {likeAnimation && (
              <div className="absolute inset-0 animate-ping">
                <svg className="w-5 h-5 text-green-400 opacity-75" fill="currentColor" viewBox="0 0 24 24">
